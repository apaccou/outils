...
concrete/bin/concrete5 c5:config set -g concrete.seo.exclude_words "a, an, as, at, before, but, by, for, from, is, in, into, like, of, off, on, onto, per, since, than, the, this, that, to, up, via, with, le, la, les, l', du, de, d', aux, dans, et"
